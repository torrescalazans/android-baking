package com.torrescalazans.baking.ui.base;
...
import com.torrescalazans.baking.injection.component.ActivityComponent;
import com.torrescalazans.baking.injection.component.ConfigPersistentComponent;
import com.torrescalazans.baking.injection.component.DaggerConfigPersistentComponent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (configPersistentComponent == null) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .applicationComponent(BakingApplication.get(this).getComponent())
                    .build();
